attenuationEffectType = "CarAttenuation"; //utlumovani v interieru (odkaz do Attenuation.hpp ve slozce SOUNDS_F
		...
		soundGetIn[]={"vurtual_mtvr\Sounds\ext-mtvr-getin",db-5,1};
		soundGetOut[]={"vurtual_mtvr\Sounds\ext-mtvr-getout",db-5,1, 40};
		soundDammage[]={"", db-5, 1};
		soundEngineOnInt[] = {"vurtual_mtvr\Sounds\int-mtvr-start", db-8, 1.0};
		soundEngineOnExt[] = {"vurtual_mtvr\Sounds\ext-mtvr-start1", db-7, 1.0, 200};
		soundEngineOffInt[] = {"vurtual_mtvr\Sounds\int-mtvr-stop", db-8, 1.0};
		soundEngineOffExt[] = {"vurtual_mtvr\Sounds\ext-mtvr-stop", db-7, 1.0, 200};
	...
	class	Sounds
	{
		...
		class	Idle_ext
		{
			sound[]	=	{"vurtual_mtvr\Sounds\ext-mtvr-idle", db-10,	1, 150};
			frequency	=	0.9	+	HZ_IDLE*0.2;
			volume = engineOn*camPos*VOLUME_IDLE;
		};
		class	Engine
		{
			sound[]	=	{"vurtual_mtvr\Sounds\ext-truck-low2",	db-8,1, 200};
			frequency	=	0.8	+	HZ_RPM1*0.2;
			volume = engineOn*camPos*VOLUME_RPM1;
		};
		class	Engine1_ext
		{
			sound[]	=	{"vurtual_mtvr\Sounds\ext-truck-low2",	db-6,1, 240};
			frequency	=	0.8	+	HZ_RPM2*0.2;
			volume = engineOn*camPos*VOLUME_RPM2;
		};
		class	Engine2_ext
		{
			sound[]	=	{"vurtual_mtvr\Sounds\ext-truck-low2",	db-5,1, 280};
			frequency	=	0.8	+	HZ_RPM3*0.2;
			volume = engineOn*camPos*VOLUME_RPM3;
		};
		class	Engine3_ext
		{
			sound[]	=	{"vurtual_mtvr\Sounds\ext-truck-high",	db-4,1, 320};
			frequency	=	0.8	+	HZ_RPM4*0.2;
			volume = engineOn*camPos*VOLUME_RPM4;
		};
		class	Engine4_ext
		{
			sound[]	=	{"vurtual_mtvr\Sounds\ext-truck-high",	db-3,1, 360};
			frequency	=	0.8	+	HZ_RPM5*0.2;
			volume = engineOn*camPos*VOLUME_RPM5;
		};
		class	Engine5_ext
		{
			sound[]	=	{"vurtual_mtvr\Sounds\ext-truck-high",	db-2,1, 420};
	  ...
	  class Engine5_Thrust_ext
	  {
		...
		class	Idle_int
		{
			sound[]	=	{"vurtual_mtvr\Sounds\int-mtvr-idle1", db-15,	1};
			frequency	=	0.9	+	HZ_IDLE*0.2;
			volume = engineOn*(1-camPos)*VOLUME_IDLE;
		};
		class	Engine_int
		{
			sound[]	=	{"vurtual_mtvr\Sounds\int-mtvr-low",	db-14,1 };
			frequency	=	0.8	+	HZ_RPM1*0.2;
			volume = engineOn*(1-camPos)*VOLUME_RPM1;
		};
		class	Engine1_int
		{
			sound[]	=	{"vurtual_mtvr\Sounds\int-mtvr-low",	db-12,1 };
			frequency	=	0.8	+	HZ_RPM2*0.2;
			volume = engineOn*(1-camPos)*VOLUME_RPM2;
		};
		class	Engine2_int
		{
			sound[]	=	{"vurtual_mtvr\Sounds\int-mtvr-low2",	db-11,1 };
			frequency	=	0.8	+	HZ_RPM3*0.2;
			volume = engineOn*(1-camPos)*VOLUME_RPM3;
		};
		class	Engine3_int
		{
			sound[]	=	{"vurtual_mtvr\Sounds\int-truck-low2",	db-10,1 };
			frequency	=	0.8	+	HZ_RPM4*0.2;
			volume = engineOn*(1-camPos)*VOLUME_RPM4;
		};
		class	Engine4_int
		{
			sound[]	=	{"vurtual_mtvr\Sounds\int-truck-high1",	db-9,1 };
			frequency	=	0.8	+	HZ_RPM5*0.2;
			volume = engineOn*(1-camPos)*VOLUME_RPM5;
		};
		class	Engine5_int
		{
			sound[]	=	{"vurtual_mtvr\Sounds\int-truck-high2",	db-6,1 };
			frequency	=	0.95	+	HZ_RPM6*0.15;
